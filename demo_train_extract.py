# -*- coding: utf-8 -*-
# @Time    : 2019/5/24 21:24
# @Author  : LegenDong
# @User    : legendong
# @File    : demo_train_extract.py
# @Software: PyCharm
import argparse
import os
import random
...
from models import FocalLoss, ArcMarginProduct, ArcFaceSEResNetModel
...
def main(args):
    ...
    save_model(model, args.save_dir, 'demo_arcface_extract_model', args.epoch)
