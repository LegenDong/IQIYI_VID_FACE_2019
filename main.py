...
def main(data_root):
    output_num, all_video_names_1, output_sum = merge_multi_view_result('./multi_view_face_result', is_save=False)
    all_outputs_1 = torch.from_numpy(output_sum / output_num)
