...
def main(args):
    ...
    dataset = IQiYiSceneFeatDataset(args.data_root, 'train+val-noise', )
    ...
    save_model(model, args.save_dir, 'demo_arcface_scene_model', args.epoch)
