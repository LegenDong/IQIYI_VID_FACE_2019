...
# @Author  : LegenDong
# @User    : legendong
# @File    : demo_train_mm_multi_view.py
# @Software: PyCharm
import argparse
import os
import pickle
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', default='./checkpoints/multi_view_face+head', type=str,
                        help='path to save model (default: ./checkpoints/multi_view/multi_view_face+head)')
    ...
    parser.add_argument('--moda', default='face+head', type=str,
                        help='modal[face, head] of model train, (default: face+head)')
