# -*- coding: utf-8 -*-
# @Time    : 2019/5/13 20:35
# @Author  : LegenDong
# @User    : legendong
# @File    : demo_train_bagging_vlad.py
# @Software: PyCharm
import argparse
import os
import random
...
from models import FocalLoss, ArcMarginProduct, ArcFaceVLADModel
...
def main(args):
    ...
    model = ArcFaceVLADModel(args.feat_dim, args.num_classes, num_cluster=args.num_cluster)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_cluster', default=3, type=int, help='number of cluster in vlad layer')
