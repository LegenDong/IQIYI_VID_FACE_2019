# -*- coding: utf-8 -*-
# @Time    : 2019/5/26 12:37
# @Author  : LegenDong
# @User    : legendong
# @File    : demo_train_bagging_scene.py
# @Software: PyCharm
import argparse
import os
import random
...
from datasets import BaseDataLoader, IQiYiSceneDataset
...
def main(args):
    ...
    dataset = IQiYiSceneDataset(args.data_root, 'train+val-noise', image_root='/home/dcq/img')
